...
const CategorySelectionScreen = ({ navigation }) => {
  ...
  const handleContinue = () => {
    if (selectedCategory !== 'Category') {
      // Pass the selected emoji to the next screen
      navigation.navigate('GroupGoal', { 
      ...
      <View style={styles.content}>
        ...
        <TouchableOpacity
          style={[
            ...
            selectedCategory !== 'Category' && styles.continueButtonActive
          ]}
              ...
              {categories.map((category) => (
                <TouchableOpacity
                  ...
                  onPress={() => {
                    ...
                    setSelectedEmoji(getCategoryEmoji(category));
